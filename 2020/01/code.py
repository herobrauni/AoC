...
# with open(os.getcwd() + "\\2020\\01\\example.txt", 'r') as f:
with open(os.getcwd() + "\\2020\\01\\input.txt", "r") as f:
    # input = f.read()
    # input = input.split("\n")
    # input = []
...
input.sort()
l1, l2 = [f for f in input if f <= 2020 / 2], [f for f in input if f > 2020 / 2]
for z in input:
    if 2020 - z in l2:
        solution_1 = z * (2020 - z)
        break
