...
final_p1, final_p2 = [c_p1[x] for x in c_p1 if len(x) == 1], [
    c_p2[x] for x in c_p2 if len(x) == 1
]
solution_1, solution_2 = max(final_p1) - min(final_p1), max(final_p2) - min(final_p2)
